...
string SimSynModule::trySelecAndReplace(map<string, set<pair<string, float> > >& synset,
					string synsetId,
...
pair<string, float> SimSynModule::selectTgtWord (map<string, int>& cand, map<string, set<pair<string, float> > >& synset, string& knnFile) {
